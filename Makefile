...
build/cross.o: src/cross.cpp src/cross.h
	g++ -std=c++11 -O2 -c -o build/cross.o src/cross.cpp
...
compile: build/cross.o build/Collision.o build/circle.o build/Disks.o build/animation.o build/RotationSim.o build/stats.o
	g++ -O2 $(LFLAGS) $(AFLAGS) build/stats.o build/cross.o build/Collision.o build/Disks.o build/RotationSim.o build/animation.o build/circle.o build/lib/glew.o -o RotationSim
